...
# IMG_PATH = project_path+'tex_new/'
IMG_PATH = data_path+'tex/'
print(data_path)
print(IMG_PATH)
PCA_PATH = data_path+'/tex32/'
IMG_EXT = '.jpg'
...
class UVDataset(Dataset):
    ...
    def __init__(self, csv_path, img_path, box_path, mask_path, PCA_PATH, transform=None, train=True):
    ...
    def __getitem__(self, index):
        ...
        return img, label, img_box, img_mask, pca_img
...
def data_gen(norm):
    ...
    for i in range(1):
        if norm == 'Y':
            train_set = UVDataset(csv,IMG_PATH, box_im_PATH, box_mask_PATH, PCA_PATH, transform=transform1, train=True)
            test_set = UVDataset(csv, IMG_PATH, box_im_PATH, box_mask_PATH, PCA_PATH, transform=transform1, train=False)
            print('Normalised')
        # Original
        else:
            train_set = UVDataset(csv,IMG_PATH, box_im_PATH, box_mask_PATH, PCA_PATH, transform=transform2, train=True)
            test_set = UVDataset(csv, IMG_PATH, box_im_PATH, box_mask_PATH, PCA_PATH, transform=transform2, train=False)
